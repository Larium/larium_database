...
class Paginator {
	 ...
	 * @return void
	 */
	protected function __construct($results, $page, $total, $per_page, $last, $request)
	{
		$this->page = $page;
		$this->last = $last;
		$this->total = $total;
	 ...
	 * @return Paginator
	 */
	public static function make($results, $total, $per_page, $request)
	{
		$page = static::page($request, $total, $per_page);

        $last = ceil($total / $per_page);

		return new static($results, $page, $total, $per_page, $last, $request);
	}
	 ...
	 * @return int
	 */
	public static function page($request, $total, $per_page)
	{
